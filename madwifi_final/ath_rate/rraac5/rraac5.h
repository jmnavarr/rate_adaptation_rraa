...
#ifndef _DEV_ATH_RATE_RRAAC5_H
#define _DEV_ATH_RATE_RRAAC5_H
...
#define	ATH_NODE_AMRR(an)	((struct rraa_c5_node *)&an[1])
#define	ATH_NODE_C5_RRAA(an)	((struct rraa_c5_node *)&an[1])
