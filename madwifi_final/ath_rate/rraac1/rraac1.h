...
#ifndef _DEV_ATH_RATE_RRAAC1_H
#define _DEV_ATH_RATE_RRAAC1_H
...
#define	ATH_NODE_AMRR(an)	((struct rraa_c1_node *)&an[1])
#define	ATH_NODE_C1_RRAA(an)	((struct rraa_c1_node *)&an[1])
