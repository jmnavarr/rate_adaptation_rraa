...
#ifndef _DEV_ATH_RATE_RRAAC4_H
#define _DEV_ATH_RATE_RRAAC4_H
...
#define	ATH_NODE_AMRR(an)	((struct rraa_c4_node *)&an[1])
#define	ATH_NODE_C4_RRAA(an)	((struct rraa_c4_node *)&an[1])
