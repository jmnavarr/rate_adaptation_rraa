...
#ifndef _DEV_ATH_RATE_RRAAC2_H
#define _DEV_ATH_RATE_RRAAC2_H
...
#define	ATH_NODE_AMRR(an)	((struct rraa_c2_node *)&an[1])
#define	ATH_NODE_C2_RRAA(an)	((struct rraa_c2_node *)&an[1])
