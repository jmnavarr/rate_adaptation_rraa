...
#ifndef _DEV_ATH_RATE_RRAAC6_H
#define _DEV_ATH_RATE_RRAAC6_H
...
struct rraa_c6_node {
  ...
  /* keep track of RTS window and counter */
  u_int rts_wnd;
  u_int rts_counter;
...
#define	ATH_NODE_AMRR(an)	((struct rraa_c6_node *)&an[1])
#define	ATH_NODE_C6_RRAA(an)	((struct rraa_c6_node *)&an[1])
